                  ...
                  <div className="row">
                    <div className="col-lg-8 m-auto text-center">
                      <div className="heading2">
                        ...
                        <p>At BTNS IT Solutions, we are dedicated to delivering innovative technology solutions <br/> tailored to meet the unique needs of businesses like yours. </p>
                    ...
                    <div className="row">
                        <div className="col-lg-4 col-md-6 col-12">
                            <div className="single-footer-items footer-logo-area">
                                ...
                                <div className="heading2">
                                    <p>At BTNS IT Solutions, we are dedicated to delivering innovative technology solutions tailored to meet the unique needs of businesses like yours. </p>
                                </div>
                        ...
                        <div className="col-lg-3 col-md-6 col-12">
                            <div className="single-footer-items">
                                ...
                                <div className="contact-box">
                                    ...
                                    <div className="pera">
                                    <a href="mailto:fidel@btns.co.za">fidel@btns.co.za</a>
                                    </div>
                                </div>
                ...
                <div className="row align-items-center">
                    <div className="col-md-5">
                        <div className="coppyright">
                            <a href = "https://btns.co.za" >Copyright @2024 BTNS.All Rights Reserved</a>
                        </div>
                    </div>
