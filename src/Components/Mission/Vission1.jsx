          ...
          <div className="row align-items-center">
            ...
            <div className="col-lg-6">
              <div className="heading1">
                ...
                <h2>Driving Innovation: Our Vision at BTNS</h2>
                <div className="space16"></div>
                <p>At BTNS, our vision is to be the leading force driving digital transformation and innovation worldwide. We envision a future where businesses of all sizes have the tools and expertise they need to thrive in an increasingly digital world.</p>
