          ...
          <div className="cs_main_header_in">
            ...
            <div className="header2-buttons">
                    <div className="button ms-2">
                      <Link
                        className="theme-btn2 plan-btn"
                        to="/plan-project"
                      >
                        Plan Your Project <span className="arrow1"><i className="bi bi-arrow-right"></i></span><span className="arrow2"><i className="bi bi-arrow-right"></i></span>
                      </Link>
                    </div>
               </div>
            </div>
