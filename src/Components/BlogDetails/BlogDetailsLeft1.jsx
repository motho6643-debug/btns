                                ...
                                <div className="details-post-area">
                                    <div className="heading1">
                                        ...
                                        <div className="comment-box">
                                            ...
                                            <div className="space20"></div>
                                            <p className="pera">The team at BTNS goes above and beyond to provide exceptional support and service. From the initial consultation to the final deployment, they were there every step of the way, ensuring a seamless integration of our new technology solution.</p>
                                        </div>
                                        ...
                                        <div className="comment-box comment-box2">
                                            ...
                                            <div className="space20"></div>
                                            <p className="pera">We approached BTNS with a complex IT problem, and they were able to provide an innovative solution that addressed our needs perfectly. Their teams creativity, technical prowess, and dedication to client satisfaction are truly commendable.</p>
                                        </div>
