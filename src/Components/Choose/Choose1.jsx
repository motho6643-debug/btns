...
const Choose1 = () => {
    ...
    const mainContent = {
        ...
        Content:'At BTNS, we understand that every business is unique, which is why we offer a range of flexible IT solutions designed to address your specific challenges and goals.',
